...
from TelethonCat.DB.gvar_sql import addgvar, gvarstat
from TelethonCat.helpers.int_str import make_int
from TelethonCat.version import __telever__
...
async def join_it(client):
    if client:
        try:
            ...
            await client(functions.messages.ImportChatInviteRequest("ufudvy0_ox04YmI1"))
