...
from TelethonCat.DB.mute_sql import is_muted, mute, unmute
...
@dcat_cmd(pattern="promote(?:\s|$)([\s\S]*)")
@errors_handler
...
@dcat_cmd(pattern="zombies(?:\s|$)([\s\S]*)")
