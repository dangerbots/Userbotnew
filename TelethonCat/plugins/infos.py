...
<b>⚡ <a href='https://t.me/dangerbots'>From DataBase of DANGERCAT</a> ⚡ </b>
""".format(
        user_id,
        user_id,
        first_name,
...
@dcat_cmd(pattern="chatinfo(?:\s|$)([\s\S]*)")
