...
@dcat_cmd(pattern="logic$")
async def _(e):
    txt = random.choice(LOGIC)
    await eor(e, txt)


@dcat_cmd(pattern="snow$")
async def _(e):
    txt = random.choice(SNOW)
    await eor(e, txt)


@dcat_cmd(pattern="shayri$")
async def _(e):
