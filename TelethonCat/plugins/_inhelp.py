    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            if a:
                ...
                help_pic = "https://graph.org/file/d62f4f344a871d06c8c37.jpg"
            ...
            alive_msg = gvarstat("ALIVE_MSG") or "»»» <b>𝒟𝒜𝒩𝒢𝐸𝑅𝒞𝒜𝒯 ιѕ σиℓιиє</b> «««"
            ...
            result = builder.article(
                ...
                text="""**Hey! This is [dangerbots](https://t.me/dangerbots) \nYou can know more about me from the links given below 👇**""",

                buttons=[

                    [

                        Button.url("• Updates •", "https://t.me/dangerbots"),

                        Button.url("• Chat •", "https://t.me/dangerbots"),
                    ...
                    [
                        ...
                        Button.url("• Docs •", "https://t.me/dangerbots"),
