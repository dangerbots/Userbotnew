...
@dcat_cmd(pattern="monster$")
async def _(monster):
    await eor(monster, G)


@dcat_cmd(pattern="pig$")
async def _(pig):
    await eor(pig, H)


@dcat_cmd(pattern="gun$")
async def _(gun):
    await eor(gun, I)


@dcat_cmd(pattern="dog$")
async def _(dog):
    await eor(dog, J)


@dcat_cmd(pattern="hello$")
async def _(hello):
    await eor(hello, K)


@dcat_cmd(pattern="hmf$")
async def _(hmf):
    await eor(hmf, L)


@dcat_cmd(pattern="couple$")
async def _(couple):
    await eor(couple, M)


@dcat_cmd(pattern="sup$")
async def _(supreme):
    await eor(supreme, N)


@dcat_cmd(pattern="india$")
async def _(event):
    await eor(event, O)
...
@dcat_cmd(pattern="snk$")
async def _(snake):
    await eor(snake, Q)


@dcat_cmd(pattern="bye$")
async def _(bye):
    await eor(bye, R)


@dcat_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@dcat_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
