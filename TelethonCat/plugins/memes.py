...
async def _(event):
    ...
    imagePath = img
    maskPath = "./catconfig/resources/pics/mask.png"
    cascPath = "./catconfig/resources/xmls/haarcascade_frontalface_default.xml"
...
@dcat_cmd(pattern="audiomeme(?:\s|$)([\s\S]*)")
async def _(event):
