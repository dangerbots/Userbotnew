...
@dcat_cmd(pattern="cry$")
async def cry(e):
    txt = random.choice(CRI)
    await eor(e, txt)


@dcat_cmd(pattern="cp(?:\s|$)([\s\S]*)")
...
@dcat_cmd(pattern="react$")
async def react_meme(react):
    await eor(react, random.choice(FACEREACTS))


@dcat_cmd(pattern="clap(?:\s|$)([\s\S]*)")
