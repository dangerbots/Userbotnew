...
from TelethonCat.DB import gmute_sql as gsql
from TelethonCat.DB.gban_sql import all_gbanned, gbaner, is_gbanned, ungbaner
from TelethonCat.DB.gvar_sql import gvarstat
...
@dcat_cmd(pattern="ungmute(?:\s|$)([\s\S]*)")
